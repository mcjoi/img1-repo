...
삼양의 tiny 시리즈 중 24와 35는 화질면에서 꽤나 호평을 받았지만, 특이한 화각 때문인지, 못생긴 생김새 때문인지, 정직한 MTF 차트 때문인지, 75는 그닥 주목받고 있지 못하는 것 같다.
::sp2  
...
다행히도, 펌웨어는 최신 버전으로 올라와 있는 제품이었다. (더 이상 업데이트를 해 줄 것 같지는 않다.)
::sp
...
문제는 F2.8까지 조여도, 시그마 56mm에 한참 못미치는 점수라는 것이다.
::sp
- lenstip 점수 <br>
